...
package pe.kr.ml.randomForest.util;
...
//                || str.equals(ArgumentsConstants.TARGET_INDEX)
                ...
                || str.equals(ArgumentsConstants.CONFIDENCE_FACTOR)
                || str.equals(ArgumentsConstants.DATA_FORMAT_PATH)
                || str.equals(ArgumentsConstants.NUM_PARTITION)
...
//		logger.info("fs.default.name" + conf.get("fs.default.name"));
